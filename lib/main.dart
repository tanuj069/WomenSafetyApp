...
import 'package:women_safety_app/voice/voice.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     final isLoggedIn = MySharedPrefference.getUserType() != null;
    return MaterialApp(
        title: 'Flutter Demo',
        ...
        home: LoginScreen()
        //isLoggedIn ? BottomPage() : LoginScreen(),
        //
        
    );
    // home: MySharedPrefference.getUserType() == "child" ? HomeScreen() : MySharedPrefference.getUserType() == "parent" : ParentHomeScreen(): LoginScreen();
  }
}
